    ...
    void scaleBatteryMeterViews() {
        ...
        if (mBatteryCustomDimension) {
            if (mBatteryStyle == BATTERY_STYLE_LANDSCAPEA ||
                ...
                mBatteryStyle == BATTERY_STYLE_RLANDSCAPE_STYLE_A ||
                mBatteryStyle ==  BATTERY_STYLE_LANDSCAPE_STYLE_A ||
                mBatteryStyle == BATTERY_STYLE_RLANDSCAPE_STYLE_B ||
                mBatteryStyle == BATTERY_STYLE_LANDSCAPE_STYLE_B  ||
                mBatteryStyle == BATTERY_STYLE_LANDSCAPE_SIGNAL   ||
                mBatteryStyle == BATTERY_STYLE_LANDSCAPE_LINE     ||
                mBatteryStyle == BATTERY_STYLE_LANDSCAPE_PILL     ||
                mBatteryStyle == BATTERY_STYLE_LANDSCAPE_MUSKU    ||
            ...
            if (mBatteryStyle == BATTERY_STYLE_LANDSCAPEA) {
                ...
                int batteryHeight = res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_big_circle_height);
                LinearLayout.LayoutParams scaledLayoutParams = new LinearLayout.LayoutParams(
                    (int) (batteryWidth * iconScaleFactor), (int) (batteryHeight * iconScaleFactor));
                scaledLayoutParams.setMargins(0, 0, 0, defaultMarginBottom);
                mBatteryIconView.setLayoutParams(scaledLayoutParams);
               ...
               int batteryWidth = res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_width_landscape_signal);
               int batteryHeight = res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_height_landscape_signal);
               LinearLayout.LayoutParams scaledLayoutParams = new LinearLayout.LayoutParams(
                   (int) (batteryWidth * iconScaleFactor), (int) (batteryHeight * iconScaleFactor));
               scaledLayoutParams.setMargins(0, 0, 0, defaultMarginBottom);
               mBatteryIconView.setLayoutParams(scaledLayoutParams);
           } else if (mBatteryStyle == BATTERY_STYLE_LANDSCAPE_LINE) {
               int batteryWidth = res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_width_landscape_line);
               int batteryHeight = res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_height_landscape_line);
               LinearLayout.LayoutParams scaledLayoutParams = new LinearLayout.LayoutParams(
                   (int) (batteryWidth * iconScaleFactor), (int) (batteryHeight * iconScaleFactor));
               scaledLayoutParams.setMargins(0, 0, 0, defaultMarginBottom);
               mBatteryIconView.setLayoutParams(scaledLayoutParams);
          } else if (mBatteryStyle == BATTERY_STYLE_LANDSCAPE_PILL || mBatteryStyle == BATTERY_STYLE_LANDSCAPE_MUSKU) {
              int batteryWidth = res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_width_landscape_pill_musku);
              int batteryHeight = res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_height_landscape_pill_musku);
              LinearLayout.LayoutParams scaledLayoutParams = new LinearLayout.LayoutParams(
                  (int) (batteryWidth * iconScaleFactor), (int) (batteryHeight * iconScaleFactor));
              scaledLayoutParams.setMargins(0, 0, 0, defaultMarginBottom);
              mBatteryIconView.setLayoutParams(scaledLayoutParams);
         } else if (mBatteryStyle == BATTERY_STYLE_LANDSCAPE_BUDDY) {
             int batteryWidth = res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_width_landscape_buddy);
              int batteryHeight = res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_height_landscape_buddy);
              LinearLayout.LayoutParams scaledLayoutParams = new LinearLayout.LayoutParams(
                  (int) (batteryWidth * iconScaleFactor), (int) (batteryHeight * iconScaleFactor));
              scaledLayoutParams.setMargins(0, 0, 0, defaultMarginBottom);
              mBatteryIconView.setLayoutParams(scaledLayoutParams);
